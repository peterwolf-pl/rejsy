...
add_action( 'init', function(){
    ...
    if ( function_exists('register_block_pattern') ) {
        register_block_pattern( 'wressla/hero', [
            'title' => 'Wressla – Hero',
            'categories' => ['wressla'],
            'content' => '<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"60px","bottom":"60px"}}}} --><div class="wp-block-group alignfull" style="padding-top:60px;padding-bottom:60px"><div class="wp-block-columns is-layout-flex"><div class="wp-block-column"><h1>Wressla – Wrocławski Tramwaj Rzeczny</h1><p>Wrocław od strony wody: kameralne rejsy katamaranem stylizowanym na tramwaj. Do 12 osób, z przewodnikiem.</p><p><a class="wp-block-button__link" href="/rezerwacja">Zarezerwuj termin</a></p></div><div class="wp-block-column"><!-- place for image --></div></div></div><!-- /wp:group -->'
        ]);
